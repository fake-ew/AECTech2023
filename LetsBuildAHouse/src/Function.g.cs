...
namespace LetsBuildAHouse
{
    public class Function
    {
        ...
        private UrlModelStore<LetsBuildAHouseInputs> store;

        public async Task<LetsBuildAHouseOutputs> Handler(LetsBuildAHouseInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<LetsBuildAHouseInputs>();
            }
            

            var l = new InvocationWrapper<LetsBuildAHouseInputs,LetsBuildAHouseOutputs> (store, LetsBuildAHouse.Execute);

...
namespace Elements
{
    ...
    {
        [JsonConstructor]
        public House(Color? @color, double @height, Profile @perimeter, Transform @transform = null, Material @material = null, Representation @representation = null, bool @isElementDefinition = false, System.Guid @id = default, string @name = null)

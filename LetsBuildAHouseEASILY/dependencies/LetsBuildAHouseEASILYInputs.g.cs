...
namespace LetsBuildAHouseEASILY
{
    ...
    
    {
        ...
        public LetsBuildAHouseEASILYInputs(Overrides @overrides, Dictionary<string, string> modelInputKeys, string gltfKey, string elementsKey, string ifcKey):
    ...
    {
        [Newtonsoft.Json.JsonConstructor]
        public HouseValue(Profile @perimeter, double @siteOffset, double @height, Color? @color)
        {
            var validator = Validator.Instance.GetFirstValidatorForType<HouseValue>();
            if(validator != null)
            {
                validator.PreConstruct(new object[]{ @perimeter, @siteOffset, @height, @color});
            }
    ...
    {
        [Newtonsoft.Json.JsonConstructor]
        public HouseOverrideAdditionValue(Profile @perimeter, double @siteOffset, double @height, Color? @color)
        {

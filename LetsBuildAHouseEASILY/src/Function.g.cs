...
namespace LetsBuildAHouseEASILY
{
    public class Function
    {
        ...
        private UrlModelStore<LetsBuildAHouseEASILYInputs> store;

        public async Task<LetsBuildAHouseEASILYOutputs> Handler(LetsBuildAHouseEASILYInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<LetsBuildAHouseEASILYInputs>();
            }
            

            var l = new InvocationWrapper<LetsBuildAHouseEASILYInputs,LetsBuildAHouseEASILYOutputs> (store, LetsBuildAHouseEASILY.Execute);
